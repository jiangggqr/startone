...
本产品包含来源、会话、Tutor、练习、反馈、Agent、材料缺口和恢复等多个状态。没有完整原型就直接开发，Codex 容易：
...
它包含 15 个可切换视图，覆盖主流程与代表性恢复分支。已删除独立的开始前测试、大屏来源查看器、学习者来源覆盖页、外部来源选择页和材料缺口确认页；来源改为讲解内的轻量引用，覆盖与缺口验证留在后台。阻断学习的命名缺口保留当前概念并打开现有上传区。生产状态完整清单以 05、06、11、12 和 evals 为准。
